...
6. Find the MAC address with `ipconfig /all`:
   ...
   Ethernet adapter Ethernet:
      ...
      Physical Address. . . . . . . . . : 68-1D-EF-FF-FF-FF
...
2. Turn off Wi-Fi on your phone and use mobile data. If the public IP is `58.123.45.67`, navigate to:
...
4. Re-test from your phone on mobile data: `http://suyons.site/frontend`
   ...
   <html lang="en">
     ...
     <body>
       <header>
         ...
         <br />
         <p>
           <a href="https://velog.io/@suyons" target="_blank"><i>Blog</i></a>
           <a href="mailto:su02ga@outlook.com" target="_blank"><b>Email</b></a>
         </p>
       </header>
       <main>
         <hr />
