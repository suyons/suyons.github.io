...
It's this: **a retail trader cannot consistently extract edge from a liquid derivatives market with a price-only strategy.** Not "it's hard." Not "you need a better model." It's the wrong fight, against the wrong opponents, on their home field. So I'm closing my CFD and futures broker accounts and moving to spot only.
...
The people on the other side of my trades aren't a fair fight. In a liquid derivatives market, my counterparty is, effectively, the most sophisticated and best-capitalized participants in finance. Any price-only pattern I can compute, they computed first, and they act on it in microseconds with costs I can't match. Bringing a price-only retail strategy to that market is bringing a calculator to a fight against people who own the calculator factory.
...
The thing I'd tell anyone about to build a retail algo-trading system on a liquid derivative: the question isn't "can I find a pattern in the price." You can. Patterns are everywhere. The question is "is there any reason this pattern would still pay *me*, retail, price-only, after the people whose job is to arbitrage it have had it for years." For liquid markets the answer is almost always no, and the rare yes is a thin edge that your own [execution gap](/posts/20260613-algo-trading-backtest-live-gap-same-bar-reentry/) will eat.
